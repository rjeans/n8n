...
- **Secure SSH Access**: Google Identity-Aware Proxy (IAP) - SSH via encrypted tunnel only
- **Zero SSH Attack Surface**: Public IP exists for outbound only, all inbound SSH blocked
